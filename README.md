...
* Calculator using functions and `match-case`
...
* Even and odd tuples
* Dictionary operations (Add, Update, Search, Display)
* Dictionary from word lengths
* Counting spaces in a string
* Set operations (Union & Intersection)
* Finding duplicate elements using sets
